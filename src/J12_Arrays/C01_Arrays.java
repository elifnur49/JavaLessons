 ...
 */
 ...
 //Array declaration
 int a;//-|declare edilen ancak assigment(atama) yapılmayan primitive variable
 int arr[];//-|declare edilen ancak assigment(atama)yapılmayan int type array
 //Trick-| ataması yapılmayan bir array herhangi action alınamaz CTREverir.
