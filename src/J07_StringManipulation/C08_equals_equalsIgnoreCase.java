...
public class C08_equals_equalsIgnoreCase {
    public static void main(String[] args) {
        ...
        String s1 = "clarusway";//String pool varaible-< gomlek cebınden cıkan para
        String s2 = "clarusway";//String pool varaible-< gomlek cebınden cıkan para
        String s3 = new String("clarusway");// String dta type obj. non-primitive->heapmemory->cüzdan
        String s4 = new String("clarusway");// String dta type obj. non-primitive->heapmemory->cüzdan
        System.out.println(s1 == s2); //true->  s1=s2 aynı string pooş dan ref. degerleri aynı.
