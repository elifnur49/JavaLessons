...
public class C14_RegExpString {
    public static void main(String[] args) {
        ...
        // [abc]    yalniz bir karakter ve a, j08_ifStatement_TernaryOperator.b veya  c olmali
        System.out.println("[abc] quantifier ....");
        System.out.println("a".matches("[a]")); // true, str yalniz bir adet a karakterinden olusmali
        System.out.println("ab".matches("[ab]")); // false, 1 karakter olmali a ya da j08_ifStatement_TernaryOperator.b, 2 karakter var
        ...
        System.out.println("c".matches("[^ab]")); // true, 1 karakter ve a ve j08_ifStatement_TernaryOperator.b nin disinda
        System.out.println("abcd".matches("[abcd]")); // false, yalniz a, j08_ifStatement_TernaryOperator.b, c veya d olmali
        System.out.println("c".matches("[abcd]")); // true, tek karakter ve a, j08_ifStatement_TernaryOperator.b, c veya d
        ...
        System.out.println("Aa".matches("[a-zA-Z]")); // false, a dan 1 karakter ve a ve j08_ifStatement_TernaryOperator.b nin disinda
        System.out.println("c".matches("[1-9]")); // false, 1 karakter ve 1-9 arasinda olmali


        // X?    X en fazla 1 defa kullanilabilir
        System.out.println("? quantifier ....");
        System.out.println("a".matches("[abc]?")); // true a, j08_ifStatement_TernaryOperator.b, c bir defa kullanilabilir
        System.out.println("aaa".matches("[abc]?")); // false, a 1 den fazla kullanilmis
        System.out.println("".matches("[abc]?")); // true, a, j08_ifStatement_TernaryOperator.b veya c en fazla 1 defa
        System.out.println("j08_ifStatement_TernaryOperator.b".matches("[abc]?")); // false, a, j08_ifStatement_TernaryOperator.b veya c en fazla 1 defa

        // X+        X en az 1 defa kullanilabilir
        System.out.println("+ quantifier ....");
        System.out.println("a".matches("[abc]+")); // true, a, j08_ifStatement_TernaryOperator.b veya c en az bir defa
        System.out.println("aaa".matches("[abc]+")); // true, a 3 defa kullanilmis
        System.out.println("aaddta".matches("[abc]+")); // false, d ve t olmamali
        System.out.println("aaabbcccc".matches("[abc]+")); // true, a, j08_ifStatement_TernaryOperator.b, c en az 1 defa kullanilmis

        // X*   X sifir veya daha fazla olmali
        System.out.println("* quantifier ....");
        System.out.println("abbbna".matches("[abc]*")); // true, a, j08_ifStatement_TernaryOperator.b, c,  0 veya fazla olmali
        System.out.println("-----" + "aaa".matches("[abc]*")); // true, a, j08_ifStatement_TernaryOperator.b, c,  0 veya fazla olmali
        System.out.println("".matches("[abc]*"));   // true, a, j08_ifStatement_TernaryOperator.b, c 0 defa kullanilmis
